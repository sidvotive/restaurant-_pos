...
└── src/
    ...
    │   ├── customers/               ← customer aggregation from orders (CRM)
...
- `src/features/customers/customerReport.test.ts` — grouping by phone/name, visits/spend, sort order
